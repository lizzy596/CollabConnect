...
const paginate = (schema) => {
     ...
     */
    schema.statics.paginate = function (filter, options, search) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const countPromise = this.countDocuments(Object.assign(Object.assign({}, filter), searchQuery)).exec();
            let docsPromise = this.find(Object.assign(Object.assign({}, filter), searchQuery))
                .sort(sort)
                .skip(skip)
                .limit(limit);
            if (options.populate) {
